...
/**
 * Represents a request to start a game session, sent from the client to the server. This class
 * includes the host's player name and a specific text that players need to type, serving as the
 * initial setup for a new game round.
 */
public class StartGameRequest {
  ...
  /**
   * Constructs a new StartGameRequest with the host's player name and the text to be typed by
   * players.
   *
