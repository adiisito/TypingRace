...
/**
 * Represents a request to update a player's progress metrics in a game. This class is used to send
 * details about a player's performance, such as typing speed, accuracy, and overall progress.
 */
public class UpdateProgressRequest {
  ...
  public UpdateProgressRequest(
      String playerName, int wpm, int progress, double accuracy, int time) {
