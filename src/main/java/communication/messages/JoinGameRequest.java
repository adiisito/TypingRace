...
/**
 * Represents a request to join a game, sent from a client to the game server. This class contains
 * all necessary details needed to process a player's request to join a game, specifically the
 * player's name.
 */
public class JoinGameRequest {
  ...
  /**
   * Sets or updates the player's name in the join game request. This can be used to correct the
   * player's name if it was entered incorrectly at the initial request.
   *
