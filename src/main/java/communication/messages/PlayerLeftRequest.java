...
/**
 * Represents a request indicating that a player has left the game. This message is used to inform
 * the server and possibly other clients that a player has discontinued their participation in the
...
public class PlayerLeftRequest {
  ...
  /**
   * Sets or updates the name of the player who has left the game. This might be used to correct or
   * update the player’s name if necessary before sending the request.
   *
