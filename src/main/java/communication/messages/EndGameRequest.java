...
/**
 * Represents a request to conclude a game session, sent from the client to the server. This class
 * encapsulates the final game statistics for a player, including their name, time spent, words per
 * minute (wpm), and accuracy percentage.
 */
