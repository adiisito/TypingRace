...
public class Text {
    ...
    static {
        textLibrary.put("Random", new String[]{
        ...
        textLibrary.put("English", new String[]{
        ...
        textLibrary.put("German", new String[]{
                ...
                "Deutschland ist bekannt fuer seine Autobahn, auf der es keine Geschwindigkeitsbegrenzung gibt.",
        ...
        textLibrary.put("Dad Jokes", new String[]{
